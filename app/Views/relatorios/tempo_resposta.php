        ...
        <main class="main-content" id="mainContent">
            ...
            <div class="dashboard-content">
                <div class="page-header mb-4">
                    ...
                    <p class="page-subtitle">Acompanhe o tempo de resposta dos atendentes e evolução</p>
                </div>
                <!-- Filtro de Período -->
                ...
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <i class="fas fa-stopwatch me-2"></i>Tempo de Resposta
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    <?php if (!empty($tempos)): foreach ($tempos as $item): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($item->atendente_nome) ?></td>
                                        <td><?= $item->total_conversas ?></td>
                                        <td><?= number_format($item->tempo_medio, 2) ?></td>
                                        <td><?= number_format($item->tempo_minimo, 2) ?></td>
                                        <td><?= number_format($item->tempo_maximo, 2) ?></td>
                                        <td><?= $item->dentro_sla ?>%</td>
                                    </tr>
                                    <?php endforeach; else: ?>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-secondary text-white">
                        <i class="fas fa-user-clock me-2"></i>Média por Atendente
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    <?php if (!empty($media_por_atendente)): foreach ($media_por_atendente as $item): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($item->atendente_nome) ?></td>
                                        <td><?= number_format($item->tempo_medio, 2) ?></td>
                                    </tr>
                ...
                <div class="card">
                    <div class="card-header bg-secondary text-white">
                        <i class="fas fa-chart-line me-2"></i>Evolução do Tempo de Resposta
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    <?php if (!empty($evolucao)): foreach ($evolucao as $item): ?>
                                    <tr>
